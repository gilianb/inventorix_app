...
class InvoiceActions {
  ...
  // ---------------------------------------------------------------------------
  // SALES: create invoice for item + PDF + Storage + auto-folder
  // ---------------------------------------------------------------------------

  /// High-level helper (SALES invoice):
  ...
  /// 3. Auto-assign folder: "<OrgName>/purchase/<Supplier>"
  ///
  ...
  Future<Invoice> attachPurchaseInvoiceForItem({
    ...
    String? buyerCompany; // ⚠ pour le nom du dossier
    ...
    // 3. Auto-folder: "<BuyerOfItem>/purchase/<Supplier>"
    try {
      // parent folder = buyer de l'item (CardShouker / Mister 8 / YK / ...)
      // si vide -> CardShouker
